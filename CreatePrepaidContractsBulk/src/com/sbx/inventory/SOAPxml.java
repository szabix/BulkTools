...
public class SOAPxml {
	...
	private String ws_xml;
	private Document xmlDocument;
	
	
	public SOAPxml(String xmlContent) throws Exception{
		xmlDocument = SOAPxml.loadXML(xmlContent);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			SOAPxml me = new SOAPxml(content);
			me.setValueNS("ReferenceId", "v11", SOAPxml.getRefID(), 1);
			me.setValue("ReferenceId", SOAPxml.getRefID(), 1);
